...
namespace Tensor {
	...
	namespace Operator {
		...
		template<typename T> 
		void Add<T>::procedure(T* out, T* arg0, T* arg1, Shape out_shape, Shape arg0_shape, Shape arg1_shape) {
		...
		template<typename T>
		void Add<T>::validate(Shape out_shape, Shape arg0_shape, Shape arg1_shape) {
		...
		template<typename T>
		bool Add<T>::requires_brodcast(Shape out_shape, Shape arg0_shape, Shape arg1_shape) {
			return !arg0_shape.is_equal(arg1_shape);
		}

		template<typename T>
		bool Add<T>::brodcast_which(Shape out_shape, Shape arg0_shape, Shape arg1_shape) {
		...
		template<typename T>
		Shape Add<T>::brodcast_shape(Shape out_shape, Shape arg0_shape, Shape arg1_shape, bool which)
		{
			return out_shape;
		}
